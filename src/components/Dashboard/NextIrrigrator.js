            ...
            <div className="!container">
                <div className="w-full sm:w-[80%] md:w-[50%]  xl:w-[35%] mx-auto max-w-sm p-8 rounded-lg shadow-md bg-base-100">
                    ...
                    <div className="flex justify-center items-center space-x-4">
                        <button onClick={() => !startStatus && activeStatus && handleOnOFF(true)} className="px-4 py-2 rounded-md bg-green-500 text-white font-semibold hover:bg-green-700 focus:outline-none">Turn On</button>
                        <button className="px-4 py-2 rounded-md bg-gray-400 text-white font-semibold hover:bg-gray-600 focus:outline-none" onClick={() => {
                            if (startStatus && activeStatus) {
                                handleOnOFF(false)
                            }
                        }}>Turn Off</button>
                    </div>
