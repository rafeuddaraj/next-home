...
export const metadata = {
  title: "Next Home ",
  description: "Next Home is your all-in-one home automation software and IoT platform. Effortlessly control your lights, thermostats, appliances, and more from a single, intuitive app. Next Home creates a seamless, personalized living experience that saves you time and energy.",
};
      ...
      <body >
        ...
        <footer className="footer items-center p-4 bg-base-300 !container">
          <aside className="items-center grid-flow-col">
            ...
            <p className="text-pink-600">Copyright © 2024 - All right reserved by UddarajIT</p>
          </aside>
